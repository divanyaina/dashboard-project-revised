...
<body class="bg-gray-100 flex h-full items-center py-16 dark:bg-neutral-800">
    ...
    <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-neutral-900 dark:border-neutral-700 w-full max-w-md mx-auto p-6">
          ...
          <div class="mt-5">
            ...
            <form action="{{ route('loginprocess')}}" method="post">
              ...
              <div class="grid gap-y-4">
                <!-- Form Group -->
                <div>
                    <label for="email" class="block font-medium  text-sm mb-2 dark:text-white">Email address</label>
                    <div class="relative">
                ...
                <div>
                  <div class="flex justify-between items-center">
                    <label for="password" class="block font-medium text-sm mb-2 dark:text-white">Password</label>
                  </div>
                  <div class="relative">
